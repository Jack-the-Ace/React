...
function Home(){
    return (
        <div>
            ...
            {/* 3) 매번 같은 데이터가 보여지는것 짜증. 속성으로 값 전달해보기(함수의 파라미터 전달됨) */}
            <MyComponent3 aaa='sam' age='20' color='red' address={{nation:'korea',city:'seoul'}}></MyComponent3>
            <MyComponent3 aaa='robin' age='25' color='green' address={{nation:'japan',city:'tokyo'}}></MyComponent3>
            <hr />
            ...
            {/* 6) 커스텀 컴포넌트 사용할때. 속성명이 자동완성안됨. 이게 되게하려면.. */}
