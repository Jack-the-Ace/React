...
import newyork from './beach.jpg'
import paris from './assets/forest.jpg'
import sydney from './assets/storm.jpg'
...
class HomeComponent extends Component{
    ...
    // 값이 변경되면 화면이 갱신되는 Component클래스의 아주 특별한 멤버변수 state
    state={
        image: newyork,
        //이미지들을 가진 배열
    ...
    render(){
        return (
            <div>
                ...
                {/* img 요소 보여주기 */}
                {/* 1. src폴더 안에 이미지 파일을 위치 */}
                {/* (경로1) html에서 처럼 파일경로를 지정하면 안보여짐 */}
                <img src="./beach.jpg" alt="img1" />
                {/* (해결) src 폴더의 이미지를 .jsx파일에서 불러와서 보여줘야 함. import */}
                <img src={newyork} alt="beach img" width={150} />
                {/* 2. src폴더 안에 이미지파일을 위치하면 파일이 너무많아 식별이 어려움. 그래서 src/assets폴더안에 이미지를 위치할 것을 권장 */}
                <img src={paris} alt="파리 이미지" width={150} />

                {/* 3. public 폴더는 index.html이 바라보는 본인 폴더위치임. */}
                {/* public 폴더에 이미지파일을 위치하고 사용해보기 */}
                <img src="./dog.png" alt="dog image" width={150}/>

                {/* 4. 웹 이미지파일의 전체 url경로(절대경로) */}
                ...
                <img src={this.state.image} alt="ny" width={200} />
