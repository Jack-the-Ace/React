...
function Home(){
    return (
        <div>
            ...
            <br />
            {/* 이방식으로 해도 페이지는 전환되지만.. SPA가 아님. 진짜로 페이지가 바뀜..페이지가 깜빡임 */}
            ...
            <p>
                <Link to='/third/1'>세번째 페이지로 이동 - 특정번호1 데이터 전달(서브경로)</Link>
            </p>
            <p>
                <Link to='/third/2'>세번째 페이지로 이동 - 특정번호2 데이터 전달(서브경로)</Link>
            </p>
            <p>
                <Link to='/third/3'>세번째 페이지로 이동 - 특정번호3 데이터 전달(서브경로)</Link>
            </p>
            <hr />
